...
@click.option('--num_video', help='number of video to export', type=int, required=True, default=1)
@click.option('--num_seeds', help='number of seeds to interpolate', type=int, required=True, default=30)
@click.option('--num_seeds_step', help='step between seeds to match', type=int, required=False, default=10)
...
def generate_images(
   ...
   # Define a new name for video export
    ...
    for i in range(1, num_video+1):
        ...
        # multi_video_seeds=[]
        # for k in custom_seed_list:
        #     multi_video_seeds.append(k) 
        
        multi_video_seeds = [k  for k in custom_seed_list]
